...
|------------------|-------------------------|-------------------------------|-------------------------|-----------------------|------------------------|----------------------------------|--------------------------------|
| ESC-GU-05   | Rendimiento             | 10K registros/minuto          | Campaña de lanzamiento  | Formulario de registro | Pico de tráfico        | Escalado horizontal + optimización de queries | <2s latency (p95)       |
...
| **Cod Escenario** | **Atributo de Calidad** | **Estímulo**                  | **Fuente del Estímulo** | **Artefacto**          | **Entorno**            | **Respuesta**                    | **Medida de Respuesta**        |
|------------------|-------------------------|-------------------------------|-------------------------|-----------------------|------------------------|----------------------------------|--------------------------------|
| ESC-GU-06   | Rendimiento             | 5K auth requests/minuto       | Evento en vivo          | Servicio de login     | Horario nocturno       | Cache JWT + read replicas        | <800ms latency (p99)         |
...
| **Cod Escenario** | **Atributo de Calidad** | **Estímulo**                  | **Fuente del Estímulo**       | **Artefacto**            | **Entorno**              | **Respuesta**                          | **Medida de Respuesta**          |
|------------------|-------------------------|-------------------------------|-------------------------------|-------------------------|--------------------------|----------------------------------------|----------------------------------|
| ESC-VP-05    | Interoperabilidad       | Cambio en modelo de recomendaciones | Actualización algoritmo ML | Sección "Recomendados" | Producción              | Implementación de API Gateway          | 99.9% éxito en llamadas cruzadas |
...
### Táctica Elegida
API Gateway con GraphQL (táctica ya tomada en la decisión arquitectónica del Módulo 03 — Escenario 01)
...
### Táctica Elegida
Webhooks con reintentos exponenciales (táctica ya tomada en la decisión arquitectónica del Módulo 03 — Escenario 02)
