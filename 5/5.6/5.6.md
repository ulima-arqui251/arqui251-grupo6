...
|------------------|-------------------------|--------------|-------------------------|---------------|-------------|---------------|-------------------------|
| ESC-GU-11 | Usabilidad | 35% de abandono en registro | Google Analytics | Formulario de registro | Mobile (60% tráfico) | Rediseño progresivo con validación inmediata | Reducción al 15% de abandono |
...
| **Cod Escenario** | **Atributo de Calidad** | **Estímulo** | **Fuente del Estímulo** | **Artefacto** | **Entorno** | **Respuesta** | **Medida de Respuesta** |
|------------------|-------------------------|--------------|-------------------------|---------------|-------------|---------------|-------------------------|
| ESC-GU-12 | Usabilidad | 40% no completan recuperación | Tickets de soporte de recuperacion de contraseña | Flujo de recuperación | Multiplataforma | Asistente interactivo | 78% completitud |
...
### Táctica Elegida
Formulario por pasos con validación en tiempo real (táctica ya tomada en la decisión arquitectónica del Módulo 01 — Escenario 01)
...
| **Cod Escenario** | **Atributo de Calidad** | **Estímulo**                                  | **Fuente del Estímulo**    | **Artefacto**               | **Entorno**               | **Respuesta**                                               | **Medida de Respuesta**                            |
|------------------|-------------------------|-----------------------------------------------|----------------------------|----------------------------|---------------------------|------------------------------------------------------------|----------------------------------------------------|
| ESC-GR-11    | Usabilidad              | Usuario nuevo intenta obtener una recomendación | Usuario final               | Interfaz de usuario (UI)   | Ambiente de producción     | Facilitar proceso de obtención con guía clara e intuitiva | Tiempo para obtener recomendación < 30 segundos    |
...
| **Cod Escenario** | **Atributo de Calidad** | **Estímulo**                                    | **Fuente del Estímulo**    | **Artefacto**               | **Entorno**               | **Respuesta**                                               | **Medida de Respuesta**                            |
|------------------|-------------------------|-------------------------------------------------|----------------------------|----------------------------|---------------------------|------------------------------------------------------------|----------------------------------------------------|
| ESC-GR-12    | Usabilidad              | Usuario frecuente realiza múltiples solicitudes | Usuario avanzado            | Interfaz de usuario (UI)   | Ambiente de producción     | Permitir acceso rápido y personalización de recomendaciones | Tiempo medio por solicitud < 10 segundos           |
...
| **Cod Escenario** | **Atributo de Calidad** | **Estímulo** | **Fuente del Estímulo** | **Artefacto** | **Entorno** | **Respuesta** | **Medida de Respuesta** |
|------------------|-------------------------|----------------------------------------|-------------------------|--------------------------------|-------------------------------------|-------------------------------------------------------------|-----------------------------------------------------|
| ESC-GPM-09 | Usabilidad | Un usuario con plan gratuito se acerca al límite de 50 valoraciones semanales | Usuario activo del sistema | Interfaz de notificaciones y sistema de contadores en Redis | Operación normal con uso intensivo de valoraciones | El sistema muestra notificaciones progresivas (40, 30, 20, 10, 0 restantes) y ofrece upgrade a premium | Notificaciones mostradas en menos de 500ms, tasa de conversión a premium del 15% cuando quedan 10 valoraciones |
