...
2. **El microservicio de Valoración Musical actualiza el estado mediante llamadas síncronas REST al microservicio de Gestión de Biblioteca:**
     - Cuando el microservicio de Valoración Musical registra una valoración (o la eliminación de una valoración), realiza una llamada REST API al microservicio de Gestión de Biblioteca.
     - El microservicio de Gestión de Biblioteca procesa la solicitud y actualiza el estado de los artistas y álbumes correspondientes.
     - Mantiene un acoplamiento controlado entre los microservicios mediante interfaces bien definidas.
     - Permite respuestas inmediatas sobre el éxito o fracaso de las actualizaciones.
     - Sigue el patrón de comunicación establecido para toda la arquitectura.
...
**Decisión:**
El microservicio de Valoración Musical actualiza el estado mediante llamadas síncronas REST al microservicio de Gestión de Biblioteca.

**Sustento:**
Este enfoque mantiene la consistencia con la decisión general de arquitectura de utilizar comunicación síncrona (RESTful API) entre microservicios. El microservicio de Valoración Musical se encarga de registrar las valoraciones y notificar directamente al microservicio de Gestión de Biblioteca para mantener la integridad de la biblioteca del usuario. La comunicación síncrona proporciona confirmación inmediata de las actualizaciones, lo que mejora la experiencia del usuario al ofrecer retroalimentación instantánea. Además, simplifica la arquitectura al evitar la necesidad de infraestructura adicional para mensajería asíncrona y facilita el seguimiento del flujo de información para depuración y mantenimiento.
