...
**Criterios de elección:**
- **Escalabilidad:** Evitar cuellos de botella por llamadas sincrónicas frecuentes en tiempo real.
- **Resiliencia:** Minimizar la dependencia directa ante la caída de otros servicios.
- **Consistencia eventual:** Aceptar cierto desfase en los datos si se garantiza consistencia eventual.
- **Tiempos de respuesta:** Optimizar la latencia en las operaciones de exploración.

**Decisión:**
Comunicación asíncrona vía eventos (mensajería).

**Sustento:**
Este enfoque permite que el módulo de exploración procese datos actualizados de forma desacoplada, sin depender de la disponibilidad inmediata de otros servicios. También favorece la escalabilidad y el rendimiento, ya que los datos necesarios para las búsquedas pueden mantenerse en una base de datos optimizada localmente, alimentada mediante eventos. Aunque se introduce cierta complejidad en la sincronización de información, esta se considera aceptable dada la naturaleza de las funcionalidades del módulo.
