...
| ID   | Nombre                                      | Historia de Usuario                                                                                                                                                                     |
|------|---------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| RF21 | Eliminar artistas y álbumes                | Como usuario, quiero eliminar artistas o álbumes de mi biblioteca, para mantener organizada solo la música que me interesa conservar.                                                   |
| RF22 | Eliminación en cascada de álbumes          | Como usuario, quiero que al eliminar un artista se eliminen automáticamente sus álbumes asociados, para no dejar registros aislados en mi biblioteca.                                  |
| RF23 | Estados de artistas y álbumes              | Como usuario, quiero que los artistas y álbumes reflejen si ya han sido completamente valorados o no, para saber mi progreso en la gestión de mi biblioteca musical.                   |
| RF24 | Valoración de canciones                    | Como usuario, quiero asignar puntuaciones individuales a cada canción de un álbum, para dejar una valoración detallada según mis preferencias.                                         |
| RF25 | Límite de valoraciones semanales           | Como usuario con plan básico, quiero tener claro que solo puedo hacer hasta 50 valoraciones semanales, para gestionar mis valoraciones sin exceder el límite.                         |
| RF26 | Guardado de valoración completa            | Como usuario, quiero guardar la valoración de un álbum solo cuando haya puntuado todas sus canciones, para asegurarme de que el álbum está completamente evaluado.                     |
| RF27 | Guardado como borrador                     | Como usuario, quiero guardar el progreso de una valoración parcial como borrador, para retomarla después sin perder mi avance.                                                         |
| RF28 | Reevaluación de canciones                  | Como usuario, quiero poder reevaluar cualquier canción cuando lo desee, para actualizar mis valoraciones sin alterar la fecha original del álbum.                                      |
| RF29 | Notificación de valoraciones restantes     | Como usuario con plan gratuito, quiero ser notificado cuando me queden 40, 30, 20, 10 o 0 valoraciones semanales, para saber cuántas oportunidades me quedan.                         |
| RF30 | Valoraciones ilimitadas para Premium       | Como usuario premium, quiero poder valorar canciones sin ninguna limitación semanal, para explorar y valorar toda mi biblioteca sin restricciones.                                     |
...
| RF35 | Botón de volver a recomendar                  | Como usuario premium, quiero poder generar nuevas recomendaciones si las actuales no me convencen, para recibir alternativas más afines a mis gustos.                                    |
